...
import { mountPopover, updatePopover, setHandlers, mountCaptureOverlay, toggleSidebar, setWidgetLoading, updateWidget, setWidgetIdle, setWidgetEnabled, updateSaveResult, drillIntoGist, jumpToDrillingLevel, getDrillingStack, updateDiagram } from "./shadow-host";
